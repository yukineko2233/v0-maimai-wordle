...
import { Users, User, HelpCircle, RefreshCw, Lightbulb, Calendar } from "lucide-react"
        ...
        <div className="w-full max-w-6xl">
          {mode === "menu" && (
            <div className="w-full mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
              {mode === "menu" && (
                <>
                  <div className="absolute left-6 top-4 bg-white px-4 py-2 rounded-full flex items-center gap-4">
                    <a
                  ...
                  <div className="absolute right-6 top-4 bg-white px-4 py-2 rounded-full flex items-center gap-4">
                    <a
              ...
              <div className="p-8 flex flex-col md:flex-row gap-4 justify-center text-center">
                <Button
                  ...
                  className="flex-1 py-8 bg-gradient-to-r from-green-500 to-teal-500 text-white"
                  size="lg"
                >
          ...
          {mode === "daily" && (
            <DailyGame onBack={() => setMode("menu")} initialSongs={songs} initialAliases={songAliases} />
          )}
